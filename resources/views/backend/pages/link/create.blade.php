...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('link.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content">
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('link') is-invalid @enderror" placeholder="Link" name="link">
                    @error('link')
