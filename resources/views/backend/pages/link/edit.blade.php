...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('link.update',$link->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content">
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control @error('link') is-invalid @enderror" placeholder="Link" name="link" value="{{$link->link}}">
                    @error('link')
            ...
            <div class="tab-pane fade show active" id="navs-wc-home">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control  @error('name.az') is-invalid @enderror " name="name[az]" value="{{$link->translate('az')->name}}" placeholder="Name az">
                        @error("name.az")
                        <small class="invalid-feedback">{{$message}}</small>
                        @enderror
                        <div class="clearfix"></div>
            ...
            <div class="tab-pane fade" id="navs-wc-profile">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input placeholder="name en" value="{{$link->translate('en')->name}}"  name="name[en]" class="form-control">
            ...
            <div class="tab-pane fade" id="navs-wc-ru">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control  @error('name.ru') is-invalid @enderror" placeholder="name ru" name="name[ru]" value="{{$link->translate('ru')->name}}">
                        @error("name.ru")
                        <small class="invalid-feedback">{{$message}}</small>
                        @enderror
                        <div class="clearfix"></div>
