...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('law.update',$law->id)}}" method="POST" enctype="multipart/form-data">
        ...
        @csrf @method('put')
            <div class="tab-content">
                  ...
                  <div class="form-group row">
                        ...
                        <a href="{{asset('storage/law/'.$law->law_name)}}" target="_blank">{{$law->law_name}}</a>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-8" style="text-align: left;">
                           ...
                           <select id="typeMenu" name="type" class="select2-demo form-control" style="width: 100%" data-allow-clear="true">
                                   <option @if($law->type='qanunlar') selected @endif value="qanunlar">qanunlar</option>
                                   <option @if($law->type='strateji-yol-xeritesi') selected @endif value="strateji-yol-xeritesi">strateji-yol-xeritesi</option>
                                   <option @if($law->type='dovlet-proqramlari') selected @endif value="dovlet-proqramlari">dovlet-proqramlari</option>
                                   <option @if($law->type='umumi-hesabatlar') selected @endif value="umumi-hesabatlar">umumi-hesabatlar</option>
                            </select>
                ...
                <div class="tab-pane fade show active" id="navs-wc-home">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.az') is-invalid @enderror " name="name[az]" value="{{$law->translate('az')->name}}" placeholder="Name az">
                            @error("name.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="name en"  name="name[en]" class="form-control" value="{{$law->translate('en')->name}}">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.ru') is-invalid @enderror" placeholder="name ru" name="name[ru]" value="{{$law->translate('ru')->name}}">
                            @error("name.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
