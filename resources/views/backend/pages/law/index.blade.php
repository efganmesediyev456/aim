...
<div class="card">
    ...
    <a  href="{{route('law.create')}}" class="btn btn-success btn-sm" style="width:100px; position:relative;top:0;right:0">Added</a>
            ...
            @foreach($laws as $law)
               <tr class="odd gradeX">
                    ...
                    <td style="display: flex;">
                       <a class="btn btn-success" href="{{route('law.edit',$law->id)}}" style="margin-right: 5px">Edit</a>
