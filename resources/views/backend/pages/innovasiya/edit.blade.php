...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('innovasiya.update',$innovasiya->id)}}" method="POST" enctype="multipart/form-data">
        ...
        @method('put')
            <div class="tab-content">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8" style="text-align: left;">
                           ...
                           <select id="typeMenu" name="type" class="select2-demo form-control" style="width: 100%" data-allow-clear="true">
                                   <option @if($innovasiya->type=='innovasiya-festivali') selected @endif value="innovasiya-festivali">innovasiya-festivali</option>
                                   <option @if($innovasiya->type=='layiheler') selected @endif value="layiheler">layiheler</option>
                            </select>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{$innovasiya->slug}}" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug" name="slug">
                            @error('slug')
                  ...
                  <div class="form-group row">
                        ...
                        <img style="width: 200px" src="  {{asset('storage/innovasiyalar/'.$innovasiya->image)}}">
                ...
                <div class="tab-pane fade show active" id="navs-wc-home">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.az') is-invalid @enderror " name="name[az]" value="{{$innovasiya->translate('az')->name}}" placeholder="Name az">
                            @error("name.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                      ...
                      <div class="form-group row ckeditor-parent">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="ckeditor2 @error('content.az') is-invalid @enderror" name="content[az]">
                                ...
                                {!!$innovasiya->translate('az')->content!!}
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="name en"  name="name[en]" class="form-control" value="{{$innovasiya->translate('en')->name}}">
                  ...
                  <div class="form-group row ckeditor-parent">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="ckeditor2 @error('content.en') is-invalid @enderror" name="content[en]">
                                {!!$innovasiya->translate('en')->content!!}
                            </textarea>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.ru') is-invalid @enderror" placeholder="name ru" name="name[ru]" value="{{$innovasiya->translate('ru')->name}}">
                            @error("name.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                 ...
                 <div class="form-group row ckeditor-parent">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="ckeditor2 @error('content.ru') is-invalid @enderror" name="content[ru]">
                                {!!$innovasiya->translate('ru')->content!!}
                            </textarea>
