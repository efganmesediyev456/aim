...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('innovasiya.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8" style="text-align: left;">
                           ...
                           <select id="typeMenu" name="type" class="select2-demo form-control" style="width: 100%" data-allow-clear="true">
                                   <option @if(old('type')=='innovasiya-festivali') selected @endif value="innovasiya-festivali">innovasiya-festivali</option>
                                   <option @if(old('type')=='layiheler') selected @endif value="layiheler">layiheler</option>
                            </select>
