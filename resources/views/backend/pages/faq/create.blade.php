...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('faq.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="navs-wc-home">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea  class="form-control  @error('content.az') is-invalid @enderror " name="content[az]"  placeholder="Content az" rows="6"> 
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea rows="6"  class="form-control  @error('content.en') is-invalid @enderror " name="content[en]"  placeholder="Content en"> 
                ...
                <div class="form-group row">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                           <textarea rows="6"  class="form-control  @error('content.ru') is-invalid @enderror " name="content[ru]"  placeholder="Content ru"> 
