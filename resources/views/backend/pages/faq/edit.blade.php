...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('faq.update',$faq->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="navs-wc-home">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.az') is-invalid @enderror " name="name[az]" value="{{$faq->translate('az')->name}}" placeholder="Name az">
                            @error("name.az")
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea  class="form-control  @error('content.az') is-invalid @enderror " name="content[az]"  placeholder="Content az" rows="6"> {{$faq->translate('az')->content}}</textarea>
                            @error("content.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="name en" value="{{$faq->translate('en')->name}}"  name="name[en]" class="form-control">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea rows="6"  class="form-control  @error('content.en') is-invalid @enderror " name="content[en]"  placeholder="Content en">{{$faq->translate('en')->content}}</textarea>
                ...
                <div class="form-group row">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                           <textarea rows="6"  class="form-control  @error('content.ru') is-invalid @enderror " name="content[ru]"  placeholder="Content ru"> {{$faq->translate('ru')->content}}</textarea>
                            @error("content.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
