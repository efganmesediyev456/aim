...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="col-sm-8" style="text-align: left;">
                           ...
                           <select id="typeMenu" name="type" class="select2-demo form-control" style="width: 100%" data-allow-clear="true">
                                   <option @if(old('type')=='xeberler') selected @endif value="xeberler">Xeberler</option>
                                   <option @if(old('status')=='musabiqeler') selected @endif value="musabiqeler">Musabiqeler</option>
                            </select>
                            <div class="clearfix"></div>
                        </div>
                  </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea name="text[en]" class="ckeditor2" id="" cols="30" rows="10"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea name="text[ru]" class="ckeditor2" id="" cols="30" rows="10"></textarea>
