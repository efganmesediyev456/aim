...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('struktur.store')}}" method="POST" enctype="multipart/form-data">
        ...
        @csrf
            <div class="tab-content">
                ...
                <div class="form-group row">
                        <label class="col-form-label col-sm-2 text-sm-right">Step</label>
                        <div class="col-sm-8" style="text-align: left;">
                           

                           <select name="step" class="select2-demo form-control" style="width: 100%" data-allow-clear="true">
