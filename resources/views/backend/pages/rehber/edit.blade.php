...
<div class="col-md">
    <div class="card text-center mb-3">
        ...
        <form class="my-4" action="{{route('rehber.update',$rehber->id)}}" method="POST" enctype="multipart/form-data">
        ...
        @csrf @method('put')
            <div class="tab-content">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{$rehber->slug}}" class="form-control @error('slug') is-invalid @enderror" placeholder="Slug" name="slug">
                            @error('slug')
                  ...
                  <div class="form-group row">
                        ...
                        <input type="file" name="image" class="form-control @error('image') is-invalid @enderror">
                         <img style="width: 200px; float: left;" src="{{asset("/storage")."/rehberler/".$rehber->image}}" alt="">
                         @error('image')
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                        </div>
                ...
                <div class="tab-pane fade show active" id="navs-wc-home">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('position.az') is-invalid @enderror " name="position[az]" value="{{$rehber->translate('az')->position}}" placeholder="position az">
                            @error("position.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.az') is-invalid @enderror " name="name[az]" value="{{$rehber->translate('az')->name}}" placeholder="Name az">
                            @error("name.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('surname.az') is-invalid @enderror " name="surname[az]" value="{{$rehber->translate('az')->surname}}" placeholder="surname az">
                            @error("surname.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('title.az') is-invalid @enderror " name="title[az]" value="{{$rehber->translate('az')->title}}" placeholder="title az">
                            @error("title.az")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="name en"  name="name[en]" class="form-control" value="{{$rehber->translate('en')->name}}">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="surname en" value="{{$rehber->translate('en')->surname}}"  name="surname[en]" class="form-control">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input value="{{$rehber->translate('en')->position}}" placeholder="position en"  name="position[en]" class="form-control">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input placeholder="title en" value="{{$rehber->translate('en')->title}}"  name="title[en]" class="form-control">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('name.ru') is-invalid @enderror" placeholder="name ru" name="name[ru]" value="{{$rehber->translate('ru')->name}}">
                            @error("name.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                 ...
                 <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('surname.ru') is-invalid @enderror" placeholder="surname ru" name="surname[ru]" value="{{$rehber->translate('ru')->surname}}">
                            @error("surname.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                 ...
                 <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('position.ru') is-invalid @enderror" placeholder="position ru" value="{{$rehber->translate('ru')->position}}" name="position[ru]">
                            @error("position.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
                 ...
                 <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control  @error('title.ru') is-invalid @enderror" placeholder="title ru" name="title[ru]" value="{{$rehber->translate('ru')->title}}">
                            @error("title.ru")
                            <small class="invalid-feedback">{{$message}}</small>
                            @enderror
                            <div class="clearfix"></div>
