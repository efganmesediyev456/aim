          ...
          <div class="col-lg-3 d-lg-none">
           ...
           <div class="col-lg-9">
            <div class="in-page__content">
              ...
              <time class="in-page__time mb-16">{{$elan->getDateYear()}}</time>
              ...
              <div class="sharer">
                ...
                <div class="right">
                  <button type="button" data-sharer="facebook" data-url="{{url()->full()}}" data-title="{{$elan->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="twitter" data-url="{{url()->full()}}" data-title="{{$elan->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="telegram"  data-url="{{url()->full()}}" data-title="{{$elan->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="whatsapp"  data-url="{{url()->full()}}" data-title="{{$elan->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="linkedin"  data-url="{{url()->full()}}" data-title="{{$elan->name}}"><i class="size20">
            ...
            <div class="second-block mt-60">
              <div class="in-page__content mobile">
                ...
                <div class="news-slider owl-carousel">
                  ...
                  @foreach($other_elanlar as $elan)
                  <a class="news-card in"   href="{{route('frond.page.child',[
