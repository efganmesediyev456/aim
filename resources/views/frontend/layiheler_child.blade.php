        ...
        <div class="row">
          <div class="col-lg-3 d-lg-none">
            ...
            <div class="in-page__content">
              ...
              <div class="in-page__cover mb-16"><img src="{{asset('storage/innovasiyalar/'.$layihe->image)}}"></div>
              <time class="in-page__time mb-16">{{$layihe->getDateYear()}}</time>
              ...
              <div class="sharer">
                ...
                <div class="right">
                  <button type="button" data-sharer="facebook" data-url="{{url()->full()}}" data-title="{{$layihe->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="twitter" data-url="{{url()->full()}}" data-title="{{$layihe->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="telegram" data-url="{{url()->full()}}" data-title="{{$layihe->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="whatsapp" data-url="{{url()->full()}}" data-title="{{$layihe->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="linkedin" data-url="{{url()->full()}}" data-title="{{$layihe->name}}"><i class="size20">
            ...
            <div class="second-block mt-60">
              <div class="in-page__content mobile">
                ...
                <div class="links slide owl-carousel">

                  @foreach($other_layiheler as $layihe)
