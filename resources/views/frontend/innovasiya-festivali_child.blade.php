         ...
         <div class="col-lg-9 p-mobile">
            <div class="in-page__content">
              <div class="in-page__title mb-24">
                <h1>{{$innovasiya->name}}</h1>
              </div>
              <div class="in-page__cover mb-16"><img src="{{asset('storage/innovasiyalar/'.$innovasiya->image)}}"></div>
              <time class="in-page__time mb-16">{{$innovasiya->getDateYear()}}</time>
              ...
              <div class="sharer">
                ...
                <div class="right">
                  <button type="button" data-sharer="facebook" data-url="{{url()->full()}}" data-title="{{$innovasiya->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="twitter" data-url="{{url()->full()}}" data-title="{{$innovasiya->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="telegram" data-url="{{url()->full()}}" data-title="{{$innovasiya->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="whatsapp" data-url="{{url()->full()}}" data-title="{{$innovasiya->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="linkedin" data-url="{{url()->full()}}" data-title="{{$innovasiya->name}}"><i class="size20">
            ...
            <div class="second-block mt-60">
              <div class="in-page__content mobile">
                ...
                <div class="news-slider owl-carousel innovation slide">
                 
                  @foreach($other_innovasiyalar as $innovasiya)
