          ...
          <div class="col-lg-9">
            <div class="in-page__content">
              <div class="in-page__title mb-24">
                <p class="mb-8">{{$multimedia->countImageAndVideo()}}</p>
                <h1>{{$multimedia->name}}</h1>
                <time class="in-page__time mt-8">{{$multimedia->getDateYear()}}</time>
              </div>
              <div class="row multimedia gy-xs-24">

                @foreach($multimedia->images as $multi)
                ...
                <div class="col-lg-4">
                  <a class="cover video" data-fancybox="demo" data-src="{{$multi->image}}"><img src="https://img.youtube.com/vi/{{explode('/',$multi->image)[count(explode('/',$multi->image))-1]}}/0.jpg"></a>
                </div>
                @elseif($multi->type=='image')


                <div class="col-lg-4">
                  <a class="cover" data-fancybox="demo" data-src="{{asset('storage/multimedia/'.$multi->image)}}"><img 
                    src="{{asset('storage/multimedia/'.$multi->image)}}"></a>
                </div>
              ...
              <div class="sharer">
                ...
                <div class="right">
                  <button type="button" data-sharer="facebook" data-url="{{url()->full()}}" data-title="{{$multimedia->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="twitter" data-url="{{url()->full()}}" data-title="{{$multimedia->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="telegram" data-url="{{url()->full()}}" data-title="{{$multimedia->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="whatsapp" data-url="{{url()->full()}}" data-title="{{$multimedia->name}}"><i class="size20">
                  ...
                  <button type="button" data-sharer="linkedin" data-url="{{url()->full()}}" data-title="{{$multimedia->name}}"><i class="size20">
